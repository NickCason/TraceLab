// test/canvas/drawOverlays.test.js
...
test('drawOverlays is a function', () => {
  expect(typeof drawOverlays).toBe('function');
});
...
test('returns empty queues when referenceOverlays is empty', () => {
  ...
  expect(result).toEqual({ overlayLabelQueue: [], overlayHandleQueue: [] });
});
